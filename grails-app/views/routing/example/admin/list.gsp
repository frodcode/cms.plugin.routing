...
<div id="content">
    ...
    <div class="container-fluid">
        <div class="row-fluid">
            <div class="span12">
                <g:if test="${flash.messages?.message}">
                    <div class="alert alert-success alert-block">
                            ${flash.messages?.message}
                    </div>
                </g:if>
                <div class="widget-box">
                    <div class="widget-title"><h5>Seznam úkolů</h5><div class="buttons"><r:link singleton="${routing_example_task.mc.adminAddSlug}" class="btn btn-mini"><i class="icon-plus"></i> Přidat úkol</r:link></div></div>
                    <div class="widget-content nopadding">
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                            <g:each in="${routing_example_task.vars.tasks}" var="task">
                                <tr>
                                    <td>
                                        <g:if test="${task.done}">Hotovo</g:if><g:else>Chybí</g:else>
                                    </td>
                                    <td>
                                        ${task.name}
                                    </td>
