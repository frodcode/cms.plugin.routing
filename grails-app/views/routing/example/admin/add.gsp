        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <div class="widget-content nopadding">
                    <r:form  singleton='${routing_example_task.mc.adminDoEditSlug}' method="post" class="form-horizontal">
                        <div class="control-group">
                            <label class="control-label">Označení (slug)</label>
                            <div class="controls">
                                <r:textField name="slug" controls="routing_example_task"/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">Název úkolu</label>
                            <div class="controls">
                                <r:textField name="name" controls="routing_example_task"/>
                            </div>
                        </div>
                        <div class="form-actions">
                            <r:hiddenField name="action" value="add" controls="routing_example_task" />
